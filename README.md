...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
    Semantic HTML is using HTML tags that discribe the content placed within the tags.
2. Name two big differences between ```display: block;``` and ```display: inline;```.
    Display block places the element on a new line of the page and takes up that entire line within the page. Inline continues on the same line as the previous element and only takes of the amount of space that is needed to contain the element within.
3. What are the 4 areas of the box model?
    The content, padding, border, and margin.
4. While using flexbox, what axis does the following property work on: ```align-items: center```?
    The cross axis.
5. Explain why git is valuable to a team of developers.
    It allows sharing of code and version control. 
